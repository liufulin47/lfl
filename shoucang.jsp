...
<body style="background-color: #FFFFFF;">
	<div id="collectionList" v-cloak>
		<!--工具条-->
		<el-row style="margin-top: 15px;">
			<el-form :inline="true" :model="filters" size="mini" ref="filters">
				<el-form-item>
			    	<el-button type="primary" icon="el-icon-search" v-on:click="getCollections">查询</el-button>
			    </el-form-item>
			    <el-form-item>
		...
		<!--列表-->
		<el-table :data="collections" border stripe size="mini" highlight-current-row v-loading="listLoading" @sort-change="handleSortChange"  @selection-change="selsChange" style="width: 100%;">
			<el-table-column type="selection" width="55"></el-table-column>
			<el-table-column type="index" width="60"></el-table-column>
			<el-table-column prop="movieId" label="电影主键" min-width="120" sortable="custom" show-overflow-tooltip></el-table-column>
		...
		<el-dialog :title="formTitle" fullscreen z-index="800" :visible.sync="formVisible" :close-on-click-modal="false">
			<el-form :model="form" label-width="80px" :rules="formRules" ref="form" size="mini">
					<el-form-item label="电影主键" prop="movieId">
						<el-input v-model="form.movieId" auto-complete="off" placeholder="请输入电影主键"></el-input>
					</el-form-item>
			</el-form>
	...
	var vue = new Vue({			
		...
		data() {
			return {
				...
				url:{
					list:'${webRoot}/collectionController.do?datagrid',
					del:'${webRoot}/collectionController.do?doDel',
					batchDel:'${webRoot}/collectionController.do?doBatchDel',
					queryDict:'${webRoot}/systemController.do?typeListJson',
					save:'${webRoot}/collectionController.do?doAdd',
					edit:'${webRoot}/collectionController.do?doUpdate',
					upload:'${webRoot}/systemController/filedeal.do',
					downFile:'${webRoot}/img/server/',
					exportXls:'${webRoot}/collectionController.do?exportXls&id=',
					ImportXls:'${webRoot}/collectionController.do?upload'
				},
				collections: [],
				total: 0,
				page: 1,
		...
		methods: {
			...
			//导入
			ImportXls: function(){
				openuploadwin('Excel导入',this.url.ImportXls, "collectionList");
			},
			//初始化数据字典
